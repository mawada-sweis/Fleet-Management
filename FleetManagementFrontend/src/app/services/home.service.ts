...
import {
  ...
  SpecificVehicleInformationRequest,
  VehicleResponse,
...
export class HomeService {
  ...
  getVehiclesDetails(): Observable<VehicleInformationsResponse> {
    return this.http.get<VehicleInformationsResponse>(
      `${this.baseUrl}/GetVehicleInformations`
    );
  }
  ...
  getSpecificVehicleDetails(vehicleId: string): Observable<VehicleResponse> {
    ...
    return this.http.post<VehicleResponse>(
      `${this.baseUrl}/GetVehicleInformation`,
      body
    );
  }
}
