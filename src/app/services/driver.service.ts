...
import { Driver, GetDriverInformationResponse } from '../drivers/get-drivers/get-drivers.model';
...
export class DriverService {
  ...
  getDriversDetails(): Observable<GetDriverInformationResponse> {
    return this.http.get<GetDriverInformationResponse>(`${this.baseUrl}/GetDriverInformation`);
  }
  ...
  addDriver(driver: Driver): Observable<GetDriverInformationResponse>{
    ...
    return this.http.post<GetDriverInformationResponse>(`${this.baseUrl}/AddDriver`, body);
  }
  ...
  updateDriver(driver: Driver): Observable<GetDriverInformationResponse>{
    ...
    return this.http.put<GetDriverInformationResponse>(`${this.baseUrl}/UpdateDriver`, body);
  }
  ...
  deleteDriver(driver: Driver): Observable<GetDriverInformationResponse>{
    ...
    return this.http.delete<GetDriverInformationResponse>(`${this.baseUrl}/DeleteDriver`, options);
  }
}
