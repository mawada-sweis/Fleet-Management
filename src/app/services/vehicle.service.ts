...
import { AddVehicleRequest, AddVehicleResponse } from '../vehicle/add-vehicle/add-vehicle.model';
...
export class VehicleService {
  ...
  addVehicle(vehicle: Vehicle): Observable<AddVehicleResponse>{
    ...
    return this.http.post<AddVehicleResponse>(`${this.baseUrl}/AddVehicle`, body);
  }
  ...
  updateVehicle(vehicle: Vehicle): Observable<AddVehicleResponse>{
    ...
    return this.http.put<AddVehicleResponse>(`${this.baseUrl}/UpdateVehicle`, body);
  }
  ...
  deleteVehicle(vehicle: Vehicle): Observable<AddVehicleResponse>{
    ...
    return this.http.delete<AddVehicleResponse>(`${this.baseUrl}/DeleteVehicle`, options);
  }
}